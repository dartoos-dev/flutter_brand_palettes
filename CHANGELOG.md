...
- bump up dependencies — [112](https://github.com/dartoos-dev/flutter_brand_palettes/issues/112).
...
- add minor corrections to the README file.
...
- bump eo_color dependency to 1.0.0
- improvements in Demo Application
